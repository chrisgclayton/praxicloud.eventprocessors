...
namespace praxicloud.eventprocessors
{
    ...
    /// </summary>
    public sealed class FixedPartitionManager : IPartitionManager
    {
        #region Delegates
        /// <summary>
        ...
        /// <inheritdoc />
        public Task<bool> IsOwnerAsync(string partitionId, CancellationToken cancellationToken)
        {
            return Task.FromResult(IsOwner(partitionId));
        }
        #endregion
    }
}
